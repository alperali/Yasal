...
const belgeler = new Map([
  ...
  [ 5957, { başlık: 'SEBZE VE MEYVELER İLE YETERLİ ARZ VE TALEP DERİNLİĞİ BULUNAN DİĞER MALLARIN TİCARETİNİN DÜZENLENMESİ HAKKINDA KANUN'} ],
  ...
  [ 3458, { başlık: 'MÜHENDİSLİK VE MİMARLIK HAKKINDA KANUN'} ],
  [ 4708, { başlık: 'YAPI DENETİMİ HAKKINDA KANUN'} ],
  [ 2873, { başlık: 'MİLLİ PARKLAR KANUNU'} ],
  [ 3194, { başlık: 'İMAR KANUNU'} ],
  ...
  [ 7595, { başlık: 'MİLLÎ DAYANIŞMA VE TOPLUMSAL BÜTÜNLEŞMENİN GÜÇLENDİRİLMESİNE DAİR KANUN'} ],
  [ 3628, { başlık: 'MAL BİLDİRİMİNDE BULUNULMASI, RÜŞVET VE YOLSUZLUKLARLA MÜCADELE KANUNU'} ],
  [ 7269, { başlık: 'UMUMİ HAYATA MÜESSİR AFETLER DOLAYISİYLE ALINACAK TEDBİRLERLE YAPILACAK YARDIMLARA DAİR KANUN'} ],
  [ 4123, { başlık: 'TABİİ AFET NEDENİYLE MEYDANA GELEN HASAR VE TAHRİBATA İLİŞKİN HİZMETLERİN YÜRÜTÜLMESİNE DAİR KANUN'} ],
  [ 5312, { başlık: 'DENİZ ÇEVRESİNİN PETROL VE DİĞER ZARARLI MADDELERLE KİRLENMESİNDE ACİL DURUMLARDA MÜDAHALE VE ZARARLARIN TAZMİNİ ESASLARINA DAİR KANUN'} ]
]);
